			...
			<div class="left">
				...
				if(isset($_SESSION['id'])){
					?>
            			...
            			<p class="grey"><a href="vm_list.php">Click Here</a> to view a list of the current virtual machines</p>
            			<h2>Request a new Virtual Machines</h2>
            			<p class="grey"><a href="form.php">Click Here</a> to request a new virtual machine</p>
            		<?php
            		}
	        	else{
	        		?>
